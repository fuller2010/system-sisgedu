            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                ...
                foreach ($classes as $row):?>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-money"></i> <span class="hide-menu"><?php echo get_phrase('Accounting'); ?><span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo base_url(); ?>index.php?admin/payments"><?php echo get_phrase('Payments'); ?></a></li>
                            <li> <a href="<?php echo base_url(); ?>index.php?admin/payment_commitment"><?php echo get_phrase('payment-commitment'); ?></a></li>
